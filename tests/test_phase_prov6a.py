...
def test_prov6a_classifies_matching_schema_with_stale_marker(tmp_path: Path) -> None:
    evidence = {
        "lineage": {
            ...
            "market_legs_indexes": [
                {
                    "name": "ix_market_legs_category_ticker",
                    "columns": ["category", "ticker"],
                    "unique": 0,
                },
                {
                    "name": "sqlite_autoindex_market_legs_1",
                    "columns": ["ticker", "leg_index"],
                    "unique": 1,
                },
            ],
            "alembic_revision": "20260623_0010",
            "revision_file_present": True,
            "revision_file_hash_matched": True,
        },
        "storage": {
            "external_device_attached": False,
            "backup_mount_ready": False,
            "backup_available_bytes": 0,
            "minimum_required_bytes": 25_000,
            "block_devices": ["vda"],
        },
        "writer": {"writer_count": 0, "holder_count": 2},
    }
    report = json.loads(write_prov6a_preview(evidence=evidence, output_dir=tmp_path).read_text())
    ...
    evidence = {
        "lineage": {
            ...
            "market_legs_indexes": [
                ...
                {"name": "u", "columns": ["ticker", "leg_index"], "unique": 1},
            ],
            "alembic_revision": "20260624_0011",
            "revision_file_present": True,
            "revision_file_hash_matched": True,
        },
        "storage": {
            "external_device_attached": True,
            "backup_mount_ready": True,
            "backup_available_bytes": 30_000,
            "minimum_required_bytes": 25_000,
