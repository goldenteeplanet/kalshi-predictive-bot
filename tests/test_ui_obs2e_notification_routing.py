...
def test_ui_obs2e_defers_noncritical_during_quiet_hours():
    preview = build_notification_routing_preview(
        {"incidents": [_incident("high-1", "HIGH")]}, _policy()
    )
    ...
    ledger = [
        {
            ...
            "severity": "CRITICAL",
            "status": "UNRESOLVED",
            "delivered_at": "2026-07-18T09:09:00Z",
        }
    ]
    ...
    ledger = [
        {
            ...
            "severity": "WARNING",
            "status": "UNRESOLVED",
            "delivered_at": "2026-07-18T18:55:00Z",
        }
    ]
    preview = build_notification_routing_preview(
...
def test_ui_obs2e_escalated_severity_bypasses_prior_lower_severity_delivery():
    ...
    preview = build_notification_routing_preview(
        {"incidents": [_incident("incident-1", "CRITICAL")]}, _policy(), ledger
    )
