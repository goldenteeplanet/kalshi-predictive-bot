...
def fixture(at: str):
    return {
        ...
        "phase_roadmap": [{}] * 20,
        "workstreams": [
            {"id": key} for key in ("pmb", "prov", "nyc_weather", "gh_liquidity", "readiness")
        ],
...
def test_three_exact_polls_pass():
    report = certify_live_poll_stability(
        [
            fixture("2026-07-19T13:00:00Z"),
            fixture("2026-07-19T13:00:30Z"),
            fixture("2026-07-19T13:01:00Z"),
        ]
    )
