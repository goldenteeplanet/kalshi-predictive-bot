...
def plan(*, filesystem, epoch, available_bytes, observed_at, decision_at,
         max_age_seconds, protected_margin_bytes, pages, phases, charges):
    ...
    return {
        ...
        'filesystem': filesystem, 'epoch': epoch,
        'observed_at': observed_at, 'decision_at': decision_at,
        'available_bytes': available, 'charged_bytes': used,
        'requested_bytes': requested, 'protected_margin_bytes': margin,
        'remaining_bytes': available - needed,
        'shortfall_bytes': max(0, needed - available),
        'reservation_created': False, 'writer_authority': False,
        'input_authenticated': False, 'allocation_enforced': False,
    }
