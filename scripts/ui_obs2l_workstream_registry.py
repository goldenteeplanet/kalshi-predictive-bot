...
parser.add_argument(
    "--snapshot", type=Path, default=Path("tests/fixtures/ui_obs1/progress_snapshot.json")
)
...
report = {
    "phase": "UI-OBS-2L",
    "mode": "LOCAL_COMPLETE_WORKSTREAM_AND_PHASE_REGISTRY",
    "status": "PASSED" if registry["coverage"]["complete"] else "FAILED",
    "registry": registry,
