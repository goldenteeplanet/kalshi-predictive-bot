...
parser = argparse.ArgumentParser(
    description="Certify captured cloud dashboard snapshot parity without deployment."
)
...
parser.add_argument(
    "--output",
    type=Path,
    default=Path("reports/phase_ui_obs5d/ui_obs5d_cloud_snapshot_parity.json"),
)
...
reference = (
    datetime.fromisoformat(args.reference_time.replace("Z", "+00:00")).astimezone(UTC)
