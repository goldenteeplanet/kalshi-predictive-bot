...
parser.add_argument(
    "--sequence", type=Path, default=Path("tests/fixtures/ui_obs2c/history_sequence.json")
)
parser.add_argument(
    "--acknowledgments", type=Path, default=Path("tests/fixtures/ui_obs2d/acknowledgments.json")
)
...
preview = build_incident_resolution_preview(
    history, args.acknowledgments, as_of="2026-07-18T09:10:00Z"
)
report = {
    "phase": "UI-OBS-2D",
    "mode": "LOCAL_READ_ONLY_INCIDENT_RESOLUTION_PREVIEW",
