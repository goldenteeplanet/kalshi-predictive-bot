...
parser.add_argument(
    "--mapping",
    type=Path,
    default=Path("reports/phase_pmb34a/pmb34a_exact_shadow_field_source_mapping_preview.json"),
)
parser.add_argument(
    "--output",
    type=Path,
    default=Path("reports/phase_pmb35a/pmb35a_exact_weather_reference_diagnostics.json"),
)
