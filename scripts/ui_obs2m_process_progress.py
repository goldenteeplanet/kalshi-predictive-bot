...
scenarios = {
    ...
    "complete": {
        ...
        "completed_units": 10,
        "total_units": 10,
        "completion_evidence": "report.json",
    },
}
results = {}
...
checks = {
    "calculable_eta": results["calculable"]["process"]["estimated_remaining"] == "40m",
    "unknown_not_invented": results["unknown_eta"]["process"]["estimated_remaining"] == "unknown",
    "stale_blocked": results["stale"]["process"]["state"] == "BLOCKED",
    "complete_zero_eta": results["complete"]["process"]["estimated_remaining_seconds"] == 0,
}
report = {
    "phase": "UI-OBS-2M",
    "mode": "LOCAL_PROCESS_PROGRESS_AND_ETA_ACCURACY",
