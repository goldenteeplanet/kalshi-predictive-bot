...
TYPING_TARGETS: tuple[str, ...] = (
    ...
    "src/kalshi_predictor/overnight_paper/cf_preparation_block.py",
    "src/kalshi_predictor/overnight_paper/cf_preparation_record.py",
    ...
    "src/kalshi_predictor/crypto/public_paper_costs.py",
    "src/kalshi_predictor/crypto/current_market_scan.py",
    "src/kalshi_predictor/crypto/current_research_intake.py",
    "src/kalshi_predictor/crypto/current_research_target.py",
    "src/kalshi_predictor/crypto/prospective_calibration.py",
    "src/kalshi_predictor/overnight_paper/current_research_store.py",
    "src/kalshi_predictor/overnight_paper/current_research_dashboard.py",
    "src/kalshi_predictor/crypto/uncertainty_contract.py",
    ...
    "src/kalshi_predictor/data_sources/tournament.py",
    ...
    "src/kalshi_predictor/paper/fees.py",
