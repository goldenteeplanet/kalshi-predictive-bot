...
CONNECTION_REGISTRY: tuple[ConnectionRegistryEntry, ...] = (
    ...
    edge(
        ...
        phase("2.6"),
        "table",
        "Eligibility, lifecycle, executable quote, freshness",
    ),
    ...
    edge(
        ...
        phase("3S"),
        "table",
        "Behavior decisions, propensities/support, rewards",
    ),
    ...
    edge(
        "E030", phase("2.6"), phase("3E"), "function", "Candidate universe and executable economics"
    ),
    edge(
        "E031",
        phase("3H"),
        phase("3S"),
        "function",
        "Specialized candidate conforms to normal contract",
    ),
    ...
    edge(
        "E039",
        phase("3V"),
        platform(PLATFORM_GATEWAY, label="Gateway"),
        "function",
        "Valid current certificate and launch envelope",
    ),
    ...
    edge(
        ...
        phase("3M"),
        "negative_assertion",
        "Synthetic cannot reach sizing/risk/gateway",
